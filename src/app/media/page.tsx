...
export default function MediaPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#F7F9FA] flex flex-col">
      <MediaHeroSection
        title="Watch Us Impact Lives"
        subtitle="Explore our gallery of photos, videos, and press releases showcasing our commitment to empowering women and girls, advancing gender equality, and celebrating the achievements of women in Imo State."
        backgroundImage="/images/commissioner2.png"
