  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 py-3 xl:py-4 transition-colors duration-500 ease-in-out ${
        scrolled ? 'bg-gradient-to-b from-[#3a2c1a]/80 to-[#232c39]/80 shadow-md' : 'bg-transparent'
      }`}
    >
...
// 'bg-gradient-to-b from-[#3a2c1a]/80 to-[#232c39]/80'} lg:bg-gradient-to-b lg:from-[#3a2c1a]/80 lg:to-[#232c39]/80